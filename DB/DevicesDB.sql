...
CREATE DATABASE IF NOT EXISTS NetworkAutomation CHARACTER SET utf8;

USE NetworkAutomation;

CREATE TABLE Device(
	id SERIAL PRIMARY KEY,
    tex_description TEXT  COMMENT "Breve descripción del dispositivo",
    ...
    tex_cpu_info TEXT NOT NULL COMMENT "Serie de CPU", 
...
CREATE TABLE BGP(
    ...
    tex_description TEXT COMMENT "Descripción del protocolo sobre el dispositivo",
...
CREATE TABLE BGPNeighbor(
    ...
    tim_date TIMESTAMP DEFAULT NOW() NOT NULL COMMENT "Fecha en que se registró el vecino",
...
CREATE TABLE BGPNetwork(
    ...
    tex_as_path TEXT NOT NULL COMMENT "AS de las redes bgp",
    tim_date TIMESTAMP DEFAULT NOW() NOT NULL COMMENT "Fecha en que se registró la red",
